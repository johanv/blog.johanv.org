...
BLOG_AUTHOR = "Johan Vervloet"  # (translatable)
BLOG_TITLE = "blog.johanv.org"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://blog.johanv.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://blog.johanv.org/"
BLOG_EMAIL = "bulk@johanv.org"
BLOG_DESCRIPTION = "Clueless, as always."  # (translatable)
...
DEPLOY_COMMANDS = {'default': [
    'rsync -pave ssh --delete output/ johanv@mijnvps:/var/www/vhosts/blog.johanv.org/',
]}
...
# )
FAVICONS = (
	("icon", "/jo-ogen-16.png", "16x16"), 
	("icon", "/jo-ogen-32.png", "32x32"), 
	("icon", "/jo-ogen-48.png", "48x48"), 
	("icon", "/jo-ogen-128.png", "128x128"), 
)
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="/pages/contact/">{author}</a> - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a> <br/>   {license}'
...
RSS_COPYRIGHT = 'Contents © {date} <a href="https://blog.johanv.org/pages/contact/">{author}</a> {license}'
...
# is in the manual.
COMMENT_SYSTEM_ID = "blogjohanvorg"
